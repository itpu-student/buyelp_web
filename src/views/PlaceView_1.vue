              ...
              <div class="sidebar-hours-block">
                <div class="sidebar-line hours-row is-link" @click="fullWeekOpen = !fullWeekOpen">
                  ...
                  <div class="toggle-icon" :class="{ rotated: fullWeekOpen }">
                    <svg viewBox="0 0 24 24" width="18" height="18"><path fill="currentColor" d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/></svg>
                  </div>
                </div>
...
import { getPlaceById, resolveTodayHours, WEEKLY_HOURS_ORDER } from "../data/places.js"
